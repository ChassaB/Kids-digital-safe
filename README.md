...
To fit the screen in the safe remove the numeric touch pad and grind away few plastic lugs then the screen will fit in as a replacement with a bit of hot glue fixing
